...
2. FAISS Retrieval     -- Fatch 'retrieval_top_k' candidate chunks.
3. Cross Encoder Re-rank -- Score and Filter down to 'reranker_top_k' chunks. 
4. Generation -- Gemini 2.5 Glash (via OpenRouter) synthesis the answer. 
